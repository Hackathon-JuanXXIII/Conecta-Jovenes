...
const VERIFICARTEL = ({ route, navigation }) => {
    ...
    useEffect(()=>{
        if(INICIO && NUMERO>0){
            ...
            }, 1000); //vaya restando de uno en una por cada segundo.
    ...
    return(
        <CONTAINER>
            ...
            <TEXTO>Por tu seguridad, te hemos enviado el código a tu teléfono {TEL}</TEXTO>
            <SUBTITULOCONTRA>Código de seguridad:</SUBTITULOCONTRA>
            <INPUTTEXTO keyboardType="numeric"/>
            ...
            <BOTON onPress={()=> navigation.navigate("NuevaPass")}>
